...
- **`<site-footer>` web component** — footer is shared via `js/components.js`. Same depth auto-detection as `<site-header>`. To change the footer, edit only `js/components.js`.
